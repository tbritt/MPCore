...
#foreach ($relationship in $entity.sortedClassRelationships)
  ...
  // SalesForce names  - tbritt
#if ($entity.userInfo.SalesForceName)
  public static final String ENTITY_SF_NAME = "$entity.userInfo.SalesForceName";
#end
#foreach ($attribute in $entity.sortedClassAttributes)
#if ($attribute.userInfo.SalesForceName)
  public static final String ${attribute.uppercaseUnderscoreName}_SF_NAME = "$attribute.userInfo.SalesForceName";
#end
#end
